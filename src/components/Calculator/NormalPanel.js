  ...
  render() {
    ...
    return (
      <div >
        ...
        <Button id="^" onClick={opClick} className={style.button}> ^ </Button>
        <Button id="exp(" onClick={opClick} className={style.button}> exp </Button>
        <Button id="i" onClick={numberClick} disabled={imagenryEnable} className={style.button}> i </Button>
