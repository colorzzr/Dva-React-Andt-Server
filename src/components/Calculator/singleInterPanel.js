  ...
  render() {
    ...
    return (
      <div >
        ...
        <Button id="y" disabled={enableY} onClick={numberClick} className={style.button}> y </Button>
        <Button id="z" disabled={enableZ} onClick={numberClick} className={style.button}> z </Button>
        <Button id="^" onClick={opClick} className={style.button}> ^ </Button>
        ...
        <Button id="clear" onClick={clear} className={style.button}> clc </Button>
        <br />
      </div>
    );
  }
